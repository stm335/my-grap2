...
st.divider()
st.info("💡 **이 그래프로 알 수 있는 것:** 여기서 알 수 있는 것은 다른 장르들은 아래로 볼록한 형태를 띄는데 공포 장르는 위로 볼록한 형태를 띕니다. 공포영화는 주로 여름이나 더운 특정 기간에 사람들이 많이 보러오기 때문에 다른 때보다 공포 장르가 특정 기간에 사람이 몰리는 것을 알 수 있습니다. 또한 대부분의 영화가 아래로 볼록하게 생긴 이유는 방학 기간에 사람들이 많이 보러 오는 정도로 생각할 수 있습니다.")
